...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	await loadBottomInfo({
		...
		bottomLeft: {text:'', x:0.1, y:0.9562, width:0.8, height:0.0143, oneLine:true, font:'gothammedium', size:0.0143},
		...
		bottomRight: {text:'', x:0.1, y:0.9562, width:0.8, height:0.0143, oneLine:true, font:'mplantin', size:0.0143, align:'right', outlineWidth:0.0005}
	});
}
